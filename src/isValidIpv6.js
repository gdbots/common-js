// I dont know what the regex does (well, I know, it validate ipv6),
// regex like this is crazy and alwasy a code smell to me
// not sure use regex is the correct way
// @link https://stackoverflow.com/questions/9208814/validate-ipv4-ipv6-and-hostname
...
/**
 * Returns true if the provided value is a ipv6 address.
 *
 * @param {string} ipv6
 * @return {boolean}
 */
export default function isValidIpv6(ipv6) {
  return IPV6_PATTERN.test(ipv6);
}
